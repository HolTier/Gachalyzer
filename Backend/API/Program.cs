...
builder.Services.AddScoped<ICharacterStatTypeRepository, CharacterStatTypeRepository>();
builder.Services.AddScoped<ICharacterStatScalingRepository, CharacterStatScalingRepository>();
